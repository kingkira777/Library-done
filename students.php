                    ...
                    <div class="card radius-15">
                        <div class="card-header">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-2">
                                    <button id="btnAddStudent" class="btn btn-light btn-sm" data-toggle="modal" data-target="#add-student-modal">
                        ...
                        <form id="form-student">
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <select class="form-control" name="gradelevel" id="gradelevel"></select>
                                </div>
                            </div>
                            <hr />
